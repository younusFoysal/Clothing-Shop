...
const Faq = () => {
    return (
            ...
            <div
                className=" w-full bg-white px-6 pt-8 pb-8  sm:mx-auto  sm:rounded-lg sm:px-10">
                <div className="mx-auto px-5">
                    ...
                    {/*    </p>*/}
                    {/*</div>*/}
                    <h2 className="text-2xl font-bold text-black mb-4">Frequent Asked Questions</h2>
                    <div className="mx-auto w-full mt-8 grid  divide-y divide-neutral-200">
                        <div className="py-5">
                            <details className="group">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">Springerdata offers a
                                    variety of
                                    billing options, including monthly and annual subscription plans, as well as
                                    pay-as-you-go
                                    pricing for certain services. Payment is typically made through a credit card or
                                    other
                        ...
                        <div className="py-5">
                            <details className="group">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">We offer a 30-day
                                    money-back
                        ...
                        <div className="py-5">
                            <details className="group">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">To cancel your
                        ...
                        <div className="py-5">
                            <details className="group">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">We offer a free trial of
                                    our software
                        ...
                        <div className="py-5">
                            <details className="group">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">We may offer discounts or
                                    promotions
